...
To avoid waiting on the phone, please create a support request via the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie). A contact form is available in the banner on the right at the bottom, via the “Create a ticket” link.
...
Explore and compare the different support levels available [here](https://www.ovhcloud.com/en-ie/support-levels/).
