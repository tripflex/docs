...
Web PaaS checks that both the `example.platform.sh` and `www.example.platform.sh` domains are pointing to your project.
...
For the DNS challenge to work, domains and subdomains should point directly to your Web PaaS cluster (unless using a [CDN](../domains/cdn/_index.md)).
