---
title: Manage Web PaaS environments
slug: environments
...
On Web PaaS, an environment is a logically separate instance of an app or group of apps
...
New environments can be created by branching existing environments using the [command line interface (CLI)](development-cli),
...
In Web PaaS, your environments are organized in a hierarchy.
...
![Agile branches with Live as the top parent, Sprint as a child, and Feature 1 and Feature 2 as children of Sprint](images/branches.svg "0.2")
...
![Features from the Sprint environment are synced with the Feature 2 environment](images/sync.svg "0.2")
...
![Features from the Sprint environment are merged into the Live environment](images/merge-live.svg "0.2")
...
* Using the CLI:
  * Run `webpaas environments --project <PROJECT_ID` or just `webpaas` within a project directory.
