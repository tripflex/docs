...
If your app needs different names for environment variable than those set by Web PaaS, which is common for database connections,
map the Web PaaS's variable names to those required by the application.
