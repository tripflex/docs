...
| [Web PaaS](./use-variables.md#use-platformsh-provided-variables)  | Pre-defined | Environment | 1          | Some  | Yes      | For information about your Web PaaS project |
...
* Service configuration for databases and such.
  This information be read from the Web PaaS-provided [`PLATFORM_RELATIONSHIPS` variable](./use-variables.md#use-platformsh-provided-variables).
