...
For full requirements, see the [requirements on GitHub](https://github.com/ovh/webpaas-cli#user-content-requirements).
...
If you run into issues or want to install manually, see the [installation instructions on GitHub](https://github.com/ovh/webpaas-cli#user-content-installation).
...
For details, see the [customization instructions on GitHub](https://github.com/ovh/webpaas-cli#user-content-customization).
