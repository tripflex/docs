...
| [Elixir](../languages-elixir) | `elixir` | 1.9, 1.10, 1.11, 1.12 |
| [Go](../languages-go) | `golang` | 1.16, 1.17, 1.18 |
| [Java](../languages-java) | `java` | 8, 11, 12, 13, 14 |
| [Lisp](../languages-lisp) | `lisp` | 1.5, 2.0, 2.1 |
| [Node.js](../languages-nodejs) | `nodejs` | 6, 8, 10, 12, 14, 16 |
| [PHP](../languages-php) | `php` | 7.3, 7.4, 8.0, 8.1 |
| [Python](../languages-python) | `python` | 2.7, 3.5, 3.6, 3.7, 3.8, 3.9, 3.10 |
...
Web PaaS provides a number of ways to set [variables](../development/variables/_index.md).
